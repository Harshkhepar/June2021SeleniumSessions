...
//		Alert alert = wait.until(ExpectedConditions.alertIsPresent());// this line will give you Alert
...
//		System.out.println(text);
		...
		//titles:
//		WebDriverWait wait = new WebDriverWait(driver, 5);
//		if(wait.until(ExpectedConditions.titleContains("Login"))) {//wait.until(ExpectedConditions.titleContains("Login"))---> this will give boolean
