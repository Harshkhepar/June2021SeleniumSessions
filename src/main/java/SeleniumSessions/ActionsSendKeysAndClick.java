...
//		act.click(driver.findElement(loginBtn)).perform();
	...
	// when we have to use normal sendkeys and click and when Actions class sendkeys and click ?
	// Dekho kafi applications mai pop up aa jaate hai jese accept cookies nd ol uss case mai 
	// hum normal method se element k sath interact ni kr paate then hume Actions class k sendkeys and click method use krne chaiye
