...
//		loginBtn.click();
		...
		// selenium click is preferred over js click bcoz selenium method click only if WebElement is displayed
		
//       Selenium does not give any method to scroll down the page so we can only scroll with js		
