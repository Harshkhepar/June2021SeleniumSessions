...
public class WebDriverWaitConcept {
	...
	public static void main(String[] args) {
		...
		// explicit wait ---> is a custom wait -> you can define your own wait for a specific element
		// not a global wait
...
//		wait.until(ExpectedConditions.presenceOfElementLocated(emailId)).sendKeys("naveen@gmail.com");
		...
		waitForElementPresence(emailId, 10, 2000).sendKeys("naveen@gmail.com");// here we change the polling for 2000 milliseconds
