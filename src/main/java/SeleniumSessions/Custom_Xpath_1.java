...
public class Custom_Xpath_1 {
	...
	public static void main(String[] args) {
		...
		//1. absolute xpath: /html/body/div/div[3]/div[4]/ul/li[3]/a --> not prefered bcoz suppose tommorw developer introduced one more div
		...
		//a(this is also xpath) --> FEs(findElements method) -- total links
		
		//htmltag[@attr1 = 'value' and @attr2 = 'value'] ---> if we have to use multiple attr
		...
		//last():
		// (//input[@class='text'])[last()] // orange hr site
		// (//div[@class='navFooterVerticalRow navAccessibility']//a)[last()] // amazon site
		// (//div[@class='navFooterVerticalRow navAccessibility']//a)[position()=last()]// amazon site
...
//		<input id = "firstname_123"> 
		// after refreshing the page then we get this ids
...
//		<input id = "firstname_456">
		...
		//*[@type='text'] -- count of 3   ---> time taking 
		//input[@type='text'] --count of 3 ---> preferred
		
		//with className method - can not use multiple classes together...
		By b1 = By.className("form-control private-form__control login-email"); //wrong -- bcoz
		// in className we have to use unique name or single class not multiple classess  ---> famous interview ques.
